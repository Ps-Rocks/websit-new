        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <a href="mailto:theinsightfoundry@gmail.com" className="flex items-center text-gray-600 hover:text-[#2c3e2d] transition-colors duration-200">
                <Mail className="w-5 h-5 mr-2" />
                theinsightfoundry@gmail.com
              </a>
            </div>
            <div>
